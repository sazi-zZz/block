...
<div class="card max-w-lg mx-auto" style="max-width: 600px; margin: 0 auto;">
    <div class="flex justify-between items-center mb-3">
        <h2>Edit Block</h2>
        <a href="<?= BASE_URL?>views/blocks/view.php?id=<?= $id?>" class="btn btn-secondary text-sm">Cancel</a>
    </div>
    ...
    <form method="POST" enctype="multipart/form-data">
        <div class="form-group text-center">
            <img src="<?= BASE_URL?>public/images/block_icons/<?= htmlspecialchars($block['icon'])?>"
