    ...
    <div class="auth-container">
        <div class="auth-card">
            ...
            <div
                ...
                <a href="<?= BASE_URL?>views/auth/login.php" class="btn btn-secondary btn-block" style="padding: 0.75rem; font-weight: 600; display: inline-flex; align-items: center; justify-content: center; width: 100%; border: 1px solid rgba(255,255,255,0.1); border-radius: var(--radius-sm); box-sizing: border-box; text-decoration: none;">Sign In</a>
